...
| D04 | База данных: таблица `user_movies` создана и работает | blocked | 10% |
...
**Текущий прогресс проекта: ~42%**

> Примечание: D04 (таблица `user_movies`) заблокирована — таблица отсутствует в Supabase БД, что блокирует D08 (статистику).
